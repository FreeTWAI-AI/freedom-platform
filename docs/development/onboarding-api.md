...
All three show `guild_master: null` until an officer is explicitly appointed; the UI displays `公會長：待任命`. Skills and equipment are self-declared separately and do not grant rank, authority or qualification.
