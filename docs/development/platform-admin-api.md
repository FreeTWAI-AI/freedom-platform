...
公會可以有一位會長和多位公會專家，同一人可分別受任兩種身分。專家是公會內的專業標章，不授予平台管理、會長討論區、公告發布、技能編輯或 GitHub 寫入權；若此人另有正式任命，仍依那份任命判斷權限。移除專家不會退出公會、收回已領技能書或撤掉另有的會長職務。本人退出公會時，專家身分同交易停用並遞增版本；重新加入不自動恢復標章。
