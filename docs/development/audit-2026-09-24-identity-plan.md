...
| Star | 本人明確點選單一 repo 才以本人授權執行；不批量、不因入會自動 Star、離會不自動 Unstar，不進 XP／rank／entitlement。產品方提出的「先按星才領書／推廣」是明確提出的要求，尚未實作為 gate；建議替代尚未獲同意。 | [公會開發資格 §新會員 GitHub 連結](guild-development-access.md#新會員-github-連結與-star-授權) |
...
| `01 §13` | 未提使用者的先 Star 要求 | 保留已提出而尚未實作的要求；現行只做本人明示單次操作 |
...
- 「先 Star 才領書／推廣」是使用者明確要求但尚未落地；建議替代尚未獲同意；現行只做本人明示的單一 repo 操作（見上表 Star 列）。
