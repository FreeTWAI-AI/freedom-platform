...
export const ASSESSMENT_VERSION='freedom-orientation-v3-creative-guilds';
export const guildTitles:Record<string,string>={
  ...
  guild_event_space:'活動與空間策劃者',guild_projection_mapping:'光影光雕創作者',guild_human_design:'人類圖共讀者',
...
export const assessmentQuestions:Question[]=[
 ...
 {id:'learning_focus',kind:'preference',prompt:'接下來你願意多花時間學習哪件事？',options:[o('community','帶新人、辦交流與支持他人學習','member_operations','talent_direction'),o('media','剪輯、字幕、視覺與內容推廣','media_automation','marketing'),o('integration','API、部署、測試與資料整合','platform_engineering','ai_vibe','ai_field'),o('commerce','商店營運、合作、對帳與供應流程','commerce_sales','product_quality_supply','commerce_settlement','opportunity_partnership'),o('security','威脅建模、安全檢查與修復驗證','security'),o('music_mv','作曲、編曲、聲音製作與 MV 敘事','music_mv'),o('commercial_production','商業攝影、廣告拍攝與客戶交付','commercial_production'),o('event_space','場地洽談、空間規劃、讀書會與活動執行','event_space'),o('projection_mapping','光雕、投影對位、動態素材與播放設計','projection_mapping'),o('human_design','人類圖共讀、原創摘要與多觀點討論','human_design')]},
