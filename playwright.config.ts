...
export default defineConfig({
  ...
  webServer:{command:'npx tsx scripts/e2e-server.ts',env:{FREEDOM_E2E_GITHUB_FIXTURES:'1'},url:'http://127.0.0.1:4311/api/v1/health',reuseExistingServer:false,timeout:30000}
});
