...
export type TabId = 'skills' | 'guild-workspace' | 'cocreation' | 'account' | 'members' | 'community' | 'squads' | 'home' | 'positioning' | 'supplier' | 'retail' | 'opensource' | 'marketing' | 'guilds' | 'workbench' | 'showcase' | 'engagement' | 'todos' | 'messages'
