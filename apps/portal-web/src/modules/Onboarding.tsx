...
export type GuildSummary = { guild_key:string;name:string;purpose:string;first_step:string;track_count:number;guild_master:{user_id?:string;display_name:string;avatar_url?:string|null}|null;guild_experts?:{user_id:string;display_name:string;avatar_url?:string|null}[];guild_master_nominee?:{display_name:string;state:'pending'}|null;is_primary:boolean;skill_books:SkillBook[];membership:{state:string;aggregate_version:number}|null };
