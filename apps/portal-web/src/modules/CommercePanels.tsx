...
export function SupplierPanel({client}:ModulePanelProps){
  ...
  return <section className="stack" aria-labelledby="supplier-heading"><header><p className="eyebrow">把你的好商品帶進來</p><h2 id="supplier-heading">供貨中心</h2><p className="lede">你提供商品與供貨條件，銷售者經營自己的店。每次合作都能看清楚對方的售價與承諾。</p></header><PreviewNote/><ClientStarter kind="supplier"/>
