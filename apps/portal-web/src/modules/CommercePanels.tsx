...
export function SupplierPanel({client}:ModulePanelProps){
  ...
  return <section className="stack" aria-labelledby="supplier-heading"><ModuleBanner eyebrow="SUPPLY / 把你的好商品帶進來" title="商品與供貨" headingId="supplier-heading" description="刊登商品、設定條件、回覆供貨請求。" art="/art/rpg/market-network.webp"/><PreviewNote/>
