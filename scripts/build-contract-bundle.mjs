...
await emit('openapi.json',pretty({openapi:'3.1.1',info:{title:'Freedom implemented member preview API',version:protocol.revision,description:'Internal member sessions only. Production OAuth, public storefront and leased executor APIs are not implemented by this bundle.'},servers:[{url:'/api/v1'}],paths,components:{schemas,securitySchemes:{MemberSession:{type:'apiKey',in:'cookie',name:'freedom_local_session'}}}}));
